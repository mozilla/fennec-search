...
public class CardStreamState {
    protected IsCard[] visibleCards;
    protected IsCard[] hiddenCards;
    protected HashSet<String> dismissibleCards;
    protected String shownTag;

    protected CardStreamState(IsCard[] visible, IsCard[] hidden, HashSet<String> dismissible, String shownTag) {
